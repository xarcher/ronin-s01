...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> businessLogicException(BusinessLogicException ex, WebRequest request) {
        var message = new ErrorMessage(HttpStatus.BAD_REQUEST.value(), new Date(), ex.getMessage(),
                request.getDescription(false));
